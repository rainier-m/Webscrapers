...
# Sub Details
subType = ['Bourbon Ridge Ham', 'Turkey', 'Ultimate', 'Italian', 'Chicken Tender', 'Roast Beef', 'Havana Bold',
           'Chicken Cordon Bleu', 'Ham', 'Deluxe', 'Philly Cheese', 'American', 'Rueben - Corned Beef', 'Maple Honey Turkey',
           'EverRoast', 'Jerk Turkey', 'Veggie', 'Tuna Salad', 'Egg Salad', 'Cuban Sub', 'Mojo Pork', 'Ham & Turkey',
           'Chicken Salad', 'Beef Meatball']
bread = ['Italian 5 Grain', 'White', 'Whole Wheat', 'Flatbread', 'Rye', 'Cuban Bread', 'Ciabatta', 'Salad']
cheese = ['Cheddar Cheese', 'Muenster Cheese', 'Provolone Cheese', 'Swiss', 'White American', 'Yellow American', 'Gouda',
          'No Cheese']
